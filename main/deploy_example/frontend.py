...
st.markdown("<p style='font-size: 14px;'>Note: You must provide an alcohol percentage or you will recieve an Internal Server Error. If you don't have data for the other values that's ok, just enter 0.0</p>", unsafe_allow_html=True)
